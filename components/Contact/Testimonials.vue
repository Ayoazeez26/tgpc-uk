...
const services = ref([
  {
    name: 'Phone Number',
    title: '+44 2074 594519 / +44 7720 185252',
    image: 'phone'
  },
  {
    name: 'Email Address',
    title: 'hello@ocmanagementconsultants.co.uk',
    image: 'mail'
  },
  {
    name: 'Office Address',
...
<template>
  <div class="flex flex-col lg:mt-[100px] lg:mb-[200px] mx-auto px-4 w-full max-w-[1240px]">
