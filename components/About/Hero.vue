      ...
      <div class="flex justify-center w-full max-w-[1240px]">
        ...
        >
          <div class="flex flex-col gap-3">
            <p class="leading-[28px] w-full max-w-[507px]">
              We aim to please
            </p>
            <h1
              class="font-semibold leading-snug text-[32px] lg:leading-snug lg:text-[40px]"
            >
              How Are We Dependable
            </h1>
          </div>
          <p class="mt-6 lg:mt-0 leading-[28px] w-full max-w-[507px]">
            DHC is passionate about delivering top-notch personal care at home,
            honoring preferences with compassion.
          </p>
        </div>
      </div>
    </div>
